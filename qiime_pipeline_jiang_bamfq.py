...
script_path = os.path.dirname(os.path.realpath(__file__)) #'/mnt/grl/brc/application/qiime_pipeline_jiang/pipeline_pgm/'
...
class Pipeline(object):
  ...
  def run_pipeline(self):
    try:
      ...
      run_qiime_string = os.path.join(script_path, "run_qiime.py") + " -- -i " + self.output + "/trimmed_fastq/all_reads.fna -o " + self.output + " -m " + self.map + " -c " + str(self.cores) + " -s " + self.sort
